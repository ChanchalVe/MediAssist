...
export const AppProvider: React.FC<AppProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    const savedMedicines = localStorage.getItem("mediassist_medicines");
    const savedDoseRecords = localStorage.getItem("mediassist_doseRecords");
    if (savedMedicines) {
      setMedicines(JSON.parse(savedMedicines));
    }
    if (savedDoseRecords) {
      setDoseRecords(JSON.parse(savedDoseRecords));
    }
  }, []);
